...
const HomePage: React.FC = () => {
    const members: Member[] = [
        ...
        },
        {
            ...
            role: 'Backend',
            image: '/jeppe.jpg',
            description:'Heisann! Jeg er en student ved UiA med en lidenskap spesielt innenfor backend-utvikling. Jeg liker å jobbe med komplekse systemer og finne effektive løsninger på tekniske utfordringer.',
            clickOnCard: 'Klikk på meg for mer informasjon!',
        },
        {
            id: 3,
